        ...
        <div className="relative min-h-screen bg-gradient-to-b from-[#f1bf14] to-[#fae8b0]">
            ...
            <div className="relative z-10 overflow-auto min-h-screen">
                ...
                <div className="w-full max-w-2xl bg-white shadow-lg rounded-lg p-6 mx-auto my-10">
                    <h1 className="text-2xl font-bold text-gray-800 text-center mb-6">Property Search</h1>    
                    ...
                    {property && (
                        <div className="mt-6 bg-white/70 backdrop-blur-lg border border-black/10 p-6 rounded-2xl shadow-lg text-black">
                            ...
                            <div className="grid grid-cols-1 gap-4 text-lg text-start  p-4 rounded-lg mt-4 text-start">
                                ...
                                <p><span className="font-semibold">📮 Postal Code:</span> {property.address?.postal1}</p>
                            ...
                            {property.building?.size?.universalSize && (
                                <p className="mt-2 text-lg"><span className="font-semibold">🪟 Estimated Windows:</span> {calculateEstimatedWindows()}</p>
                            )}
                            {/* Square footage */}
                            {property.building?.size?.universalSize && (
                                <p className="mt-2 text-lg"><span className="font-semibold">📏 Size:</span> {property.building.size.universalSize} sqft</p>
                            )}
                        </div>
                    )}
                    ...
                    {showEnergyUsage && energyUsage && (
                        <div className="mt-6 bg-white/70 backdrop-blur-lg border border-black/10 p-6 rounded-2xl shadow-lg text-black">
                            <h2 className="text-2xl font-bold text-black mb-4 border-b border-black/10 pb-2">⚡ Energy Usage</h2>
                            <div className="text-lg text-start">
                                ...
                                <p>
                                    <span className="font-semibold">📆 Billing Period:</span> {energyUsage.billing_period}
                                </p>
                            </div>
                        </div>
                    )}
